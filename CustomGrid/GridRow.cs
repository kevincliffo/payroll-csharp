...
namespace CustomGrid
{
    ...
    #region GridRow - subclasses the DataGridView's DataGridViewRow class
    /// <summary>
    /// In order to support grouping with the same look & feel as Outlook, the behaviour
    /// of the DataGridViewRow is overridden by the GridRow.
    /// The GridRow has 2 main additional properties: the Group it belongs to and
    /// a the IsRowGroup flag that indicates whether the GridRow object behaves like
    ...
    public class GridRow : DataGridViewRow
    {
        ...
        public GridRow(GridGroup group)
            : this(group, false)
        {
        }

        public GridRow(GridGroup group, bool isGroupRow)
            : base()
        {
            this.group = group;
        ...
        protected override void Paint(System.Drawing.Graphics graphics, System.Drawing.Rectangle clipBounds, System.Drawing.Rectangle rowBounds, int rowIndex, DataGridViewElementStates rowState, bool isFirstDisplayedRow, bool isLastVisibleRow)
        {
            if (this.isGroupRow)
            {
                ...
                CustomDataGrid grid = (CustomDataGrid)this.DataGridView;
    ...
    #endregion GridRow - subclasses the DataGridView's DataGridViewRow class

    #region GridRowComparer implementation
    /// <summary>
    /// the GridRowComparer object is used to sort unbound data in the OutlookGrid.
    ...
    internal class GridRowComparer : IComparer
    {
        ...
        public GridRowComparer(int columnIndex, ListSortDirection direction)
        {
        ...
        {
            GridRow obj1 = (GridRow)x;
            GridRow obj2 = (GridRow)y;
    ...
    #endregion GridRowComparer implementation
