...
namespace CustomGrid
{
    ...
    public partial class CustomDataGrid : DataGridView
    {
        ...
        public CustomDataGrid()
        {
            ...
            // in this case our custom GridRow class
            base.RowTemplate = new GridRow();
        ...
        private GridGroup groupTemplate;
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public GridGroup GroupTemplate
        {
            get
            {
        ...
        public override void Sort(DataGridViewColumn dataGridViewColumn, ListSortDirection direction)
        {
            ...
            dataSource.Sort(new GridRowComparer(dataGridViewColumn.Index, direction));
            FillGrid(groupTemplate);
        }
        ...
        {
            GridRow row = (GridRow)base.Rows[e.RowIndex];
            if (row.IsGroupRow)
                e.Cancel = true;
            else
        ...
        /// </summary>
        private void FillGrid(GridGroup groupingStyle)
        {
            ...
            if (groupingStyle == null)
            {
                ...
                {
                    row = (GridRow)this.RowTemplate.Clone();
            ...
            else
            {
                ...
                foreach (DataSourceRow r in list)
                {
                    ...
                    else // item is not part of the group, so create new group
                    {
                        ...
                        groupCur = (GridGroup)groupingStyle.Clone(); // init
