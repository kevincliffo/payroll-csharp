...
{
    #region GridGroup - declares the arrange/grouping interface here

    /// <summary>
    /// GridGroup specifies the interface of any implementation of a OutlookGridGroup class
    /// Each implementation of the GridGroup can override the behaviour of the grouping mechanism
    ...
    /// </summary>
    public interface GridGroup : IComparable, ICloneable
    {
        /// <summary>
    ...
    /// <summary>
    /// each arrange/grouping class must implement the GridGroup interface
    ...
    /// </summary>
    public class OutlookgGridDefaultGroup : GridGroup
    {
