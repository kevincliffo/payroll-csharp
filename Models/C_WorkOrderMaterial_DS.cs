...
namespace Models
{
    public class WorkOrderMaterials_DS : I_DataServer
    {
        ...
        private const string szxWORK_ORDER_MATERIALS_TableKey = "WorkOrderMaterials";

        public WorkOrderMaterials_DS(DatabaseConnection dbcv) 
        {
            dbcx = dbcv;
            fdsx = new Fields();
            ...
            dbcx.DBTables.AddDBTable(szxWORK_ORDER_MATERIALS_TableKey, 
                                     ref dbtx);

            XX_GetFieldsCollectionOverTableName(ref fdsx);

            dbcx.CreateTableForFirstTimeUseIf(szxWORK_ORDER_MATERIALS_TableKey, 
                                              fdsx);

        }

        public void GetWorkOrderMaterialOverMaterialId(long lvMaterialId,
                                                       ref Fields fdsr,
                                                       ...
                                                       ref string szrErrorMessage)
        {
            ...
            szSQL = "SELECT * FROM WorkOrderMaterials WHERE MaterialId =" + Convert.ToString(lvMaterialId);
                                               ...
                                               ref string szrErrorMessage)
        {
            ...
            szSQL = "SELECT * FROM WorkOrderMaterials "
                  + " WHERE   WorkOrderNumber = '" + fdsr.ItemIsField("WorkOrderNumber").StringValue + "' "
                  + " ORDER BY MaterialId ASC LIMIT 1";
                                              ...
                                              ref string szrErrorMessage)
        {
            ...
            szSQL = "SELECT * FROM WorkOrderMaterials "
                  + " WHERE MaterialId > "               + fdsr.ItemIsField("MaterialId").StringValue
                                                  ...
                                                  ref string szrErrorMessage)
        {
            ...
            szSQL = "SELECT * FROM WorkOrderMaterials "
                  + " WHERE MaterialId < " + fdsr.ItemIsField("MaterialId").StringValue
                  + " AND   WorkOrderNumber = '" + fdsr.ItemIsField("WorkOrderNumber").StringValue + "' "
                  + " ORDER BY MaterialId DESC LIMIT 1";
                                                           ...
                                                           ref string szrErrorMessage)
        {
            ...
            szSQL = "DELETE FROM WorkOrderMaterials "
                  + " WHERE MaterialId = " + fdsv.ItemIsField("MaterialId").StringValue
                                       ...
                                       ref string szrErrorMessage)
        {
            ...
            szSQL = "DELETE FROM WorkOrderMaterials WHERE MaterialId = " + fdsv.ItemIsField("MaterialId").StringValue;
        ...
        private void XX_GetNextMaterialId(ref long lrMaterialId)
        {
            ...
            szSQL = "SELECT MAX(MaterialId) FROM WorkOrderMaterials";
        ...
        private void XX_GetFieldsCollectionOverTableName(ref Fields fdsr)
        {
            ...
            szTableFilePath = dbcx.ApplicationPathCarrier.TablesPath + @"\" + "WorkOrderMaterials.tbl";
            ...
            while (true)
            {
                ...
                if (!bFileExists)
                {
                    MessageBox.Show("WorkOrderMaterials table not found",
                                    "Missing Table File");
                }
