...
namespace Models
{
    public class WorkOrderTemplateMaterials_DS : I_DataServer
    {
        ...
        private const string szxWORK_ORDER_TEMPLATE_MATERIALS_TableKey = "WorkOrderTemplateMaterials";

        public WorkOrderTemplateMaterials_DS(DatabaseConnection dbcv) 
        {
            dbcx = dbcv;
            fdsx = new Fields();
            ...
            dbcx.DBTables.AddDBTable(szxWORK_ORDER_TEMPLATE_MATERIALS_TableKey, 
                                     ref dbtx);

            XX_GetFieldsCollectionOverTableName(ref fdsx);

            dbcx.CreateTableForFirstTimeUseIf(szxWORK_ORDER_TEMPLATE_MATERIALS_TableKey, 
                                              fdsx);

        }

        public void GetWorkOrderTemplateMaterialOverMaterialId(long lvMaterialId,
                                                                                ref Fields fdsr,
...

        {
            ...
            szSQL = "SELECT * FROM WorkOrderTemplateMaterials WHERE MaterialId =" + Convert.ToString(lvMaterialId);
...

        {
            ...
            szSQL = "SELECT * FROM WorkOrderTemplateMaterials "
                                                           ...
                                                           ref string szrErrorMessage)
        {
            ...
            szSQL = "DELETE FROM WorkOrderTemplateMaterials "
                  + " WHERE   "
                  + " MaterialId = " + fdsv.ItemIsField("MaterialId").StringValue
                                       ...
                                       ref string szrErrorMessage)
        {
            ...
            szSQL = "DELETE FROM WorkOrderTemplateMaterials WHERE MaterialId = " + fdsv.ItemIsField("MaterialId").StringValue;
        ...
        private void XX_GetNextMaterialId(ref long lrMaterialId)
        {
            ...
            szSQL = "SELECT MAX(MaterialId) FROM WorkOrderTemplateMaterials";
        ...
        private void XX_GetFieldsCollectionOverTableName(ref Fields fdsr)
        {
            ...
            szTableFilePath = dbcx.ApplicationPathCarrier.TablesPath + @"\" + "WorkOrderTemplateMaterials.tbl";
            ...
            while (true)
            {
                ...
                if (!bFileExists)
                {
                    MessageBox.Show("WorkOrderTemplateMaterials table not found",
                                    "Missing Table File");
                }
