...
namespace Models
{
    public class Departments_DS : I_DataServer
    {
        ...
        private string szxCurrentDepartmentId = "";
        private const string szxDEPARTMENTS_TableKey = "Departments";

        public Departments_DS(DatabaseConnection dbcv) 
        {
            dbcx = dbcv;
            fdsx = new Fields();
            utsx = new Utilities.Utilities();
            szxCurrentDepartmentId = "0";
            sqlgx = new SQLGenerator();

            dbcx.DBTables.AddDBTable(szxDEPARTMENTS_TableKey, 
                                     ref dbtx);

            XX_GetFieldsCollectionOverTableName(ref fdsx);

            dbcx.CreateTableForFirstTimeUseIf(szxDEPARTMENTS_TableKey, 
                                              fdsx);

        }

        public void GetDepartmentOverDepartmentName(string szvDepartmentName,
                                                    ref Fields fdsr,
...

        {
            ...
            szSQL = "SELECT * FROM Departments WHERE DepartmentName ='" + szvDepartmentName + "'";
...

        {
            ...
            szSQL = "SELECT * FROM Departments ORDER BY DepartmentId ASC LIMIT 1";
...

        {
            ...
            szSQL = "SELECT * FROM Departments WHERE DepartmentId > " + fdsr.ItemIsField("DepartmentId").StringValue + " ORDER BY DepartmentId ASC LIMIT 1";
...

        {
            ...
            szSQL = "SELECT * FROM Departments WHERE DepartmentId < " + fdsr.ItemIsField("DepartmentId").StringValue + " ORDER BY DepartmentId DESC LIMIT 1";
...

        {
            ...
            szSQL = "SELECT * FROM Departments ORDER BY DepartmentId DESC LIMIT 1";
                                                     ...
                                                     ref Fields fdsr)
        {
            ...
            szxCurrentDepartmentId = mysql_drr[pk.FieldName].ToString();
                                  ...
                                  ref string szrErrorMessage)
        {
            ...
            while(true)
            {
                ...
                XX_GetNextDepartmentId(ref lDepartmentId);

                fdsv.ItemIsField("DepartmentId").StringValue = Convert.ToString(lDepartmentId);
                                       ...
                                       ref string szrErrorMessage)
        {
            ...
            szSQL = "DELETE FROM Departments WHERE DepartmentId = " + fdsv.ItemIsField("DepartmentId").StringValue;
        ...
        {
            XX_GetNextDepartmentId(ref lrId);
        }

        private void XX_GetNextDepartmentId(ref long lrDepartmentId)
        {
                                        string szSQL = string.Empty;
                                        MySqlDataReader mysql_dr = null;
                                        long lDepartmentId = 0;
            ...
            szSQL = "SELECT MAX(DepartmentId) FROM Departments";
            ...
            while (true)
            {
                ...
                if (mysql_dr.Read())
                {
                    try
                    {
                        lDepartmentId = Convert.ToInt32(mysql_dr[0].ToString());
                    }
                    catch
                    {
                        lDepartmentId = 0;
            ...
            lrDepartmentId = lDepartmentId + 1;
        }
        ...
        private void XX_GetFieldsCollectionOverTableName(ref Fields fdsr)
        {
            ...
            szTableFilePath = dbcx.ApplicationPathCarrier.TablesPath + @"\" + "Departments.tbl";
            ...
            while (true)
            {
                ...
                if (!bFileExists)
                {
                    MessageBox.Show("Departments table not found",
                                    "Missing Table File");
                }
