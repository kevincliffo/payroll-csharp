...
namespace Models
{
    public class Works_DS : I_DataServer
    {
        ...
        private const string szxWORKS_TableKey = "Works";

        public Works_DS(DatabaseConnection dbcv) 
        {
            dbcx = dbcv;
            fdsx = new Fields();
            ...
            dbcx.DBTables.AddDBTable(szxWORKS_TableKey, 
                                     ref dbtx);

            XX_GetFieldsCollectionOverTableName(ref fdsx);

            dbcx.CreateTableForFirstTimeUseIf(szxWORKS_TableKey, 
                                              fdsx);

        }

        public void GetWorkOverWorkId(long lvWorkId,
                                      ref Fields fdsr,
...

        {
            ...
            szSQL = "SELECT * FROM Works WHERE WorkId =" + Convert.ToString(lvWorkId);
...

        {
            ...
            szSQL = "SELECT * FROM Works ORDER BY WorkId ASC LIMIT 1";
...

        {
            ...
            szSQL = "SELECT * FROM Works WHERE WorkId > " + fdsr.ItemIsField("WorkId").StringValue + " ORDER BY + WorkId ASC LIMIT 1";
...

        {
            ...
            szSQL = "SELECT * FROM Works WHERE WorkId < " + fdsr.ItemIsField("WorkId").StringValue + " ORDER BY WorkId DESC LIMIT 1";
...

        {
            ...
            szSQL = "SELECT * FROM Works ORDER BY WorkId DESC LIMIT 1";
                                       ...
                                       ref string szrErrorMessage)
        {
            ...
            szSQL = "DELETE FROM Works WHERE WorkId = " + fdsv.ItemIsField("WorkId").StringValue;
        ...
        private void XX_GetNextWorkId(ref long lrWorkId)
        {
            ...
            szSQL = "SELECT MAX(WorkId) FROM Works";
        ...
        private void XX_GetFieldsCollectionOverTableName(ref Fields fdsr)
        {
            ...
            szTableFilePath = dbcx.ApplicationPathCarrier.TablesPath + @"\" + "Works.tbl";
            ...
            while (true)
            {
                ...
                if (!bFileExists)
                {
                    MessageBox.Show("Works table not found",
                                    "Missing Table File");
                }
